...
export function CommandSearch({ open, onOpenChange }: CommandSearchProps) {
  ...
  const searchItems: SearchItem[] = [
    // Menu Utama
    { title: "Dashboard - Ringkasan Eksekutif", url: "/dashboard", group: "Menu Utama", icon: LayoutDashboard },

    // Pembangunan & RFK
    { title: "Paket Pembangunan - Pagu & RUP", url: "/pembangunan", group: "Pembangunan & RFK", icon: Briefcase },
    { title: "Realisasi Bulanan - Fisik & SP2D (RFK)", url: "/realisasi", group: "Pembangunan & RFK", icon: TrendingUp },
    { title: "Laporan & Evaluasi - Deviasi & Rekap", url: "/laporan", group: "Pembangunan & RFK", icon: FileBarChart },

    // Sistem & Pengguna
    { title: "Manajemen Pengguna - RBAC & E-Gov", url: "/users", group: "Sistem & Pengguna", icon: Users },
    { title: "Kelompok Pengguna - Matriks Hak Akses & Menu", url: "/roles", group: "Sistem & Pengguna", icon: ShieldCheck },
  ]
