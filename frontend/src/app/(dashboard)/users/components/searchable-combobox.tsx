...
export function SearchableCombobox({
  ...
  const displayLabel = value === "all" ? allLabel : selectedItem?.label || placeholder
              ...
              >
                <Check
                  className={cn(
                    ...
                    value === "all" ? "opacity-100 text-emerald-600" : "opacity-0"
                  )}
                />
              ...
              {items.map((item) => (
                ...
                >
                  <Check
                    className={cn(
                      "mr-2 h-3.5 w-3.5 shrink-0",
                      value === item.id ? "opacity-100 text-emerald-600" : "opacity-0"
                    )}
                  />
