...
export const SIMANTAP_ROLES = [
  {
    ...
    desc: "Akses penuh sistem, kelola seluruh pengguna, konfigurasi modul. Tim Bagian Adm. Pembangunan Setda.",
    badgeClass: "bg-red-500/10 text-red-600 dark:text-red-400 border-red-500/20",
  },
  {
    value: "ADMIN_SIRUP",
    label: "Admin SiRUP (Data Awal Paket)",
    shortLabel: "Admin SiRUP",
    desc: "Input data awal kegiatan pembangunan: kode RUP, pagu, kontrak, rekanan, lokasi dari SiRUP LKPP.",
    badgeClass: "bg-blue-500/10 text-blue-600 dark:text-blue-400 border-blue-500/20",
  },
  {
    value: "ADMIN_PERENCANAAN",
    label: "Admin Perencanaan (Kurva-S Target)",
    shortLabel: "Admin Perencanaan",
    desc: "Menyusun rencana target fisik per bulan B01–B12 (Kurva-S): kapan 30%, 60%, 100% harus tercapai.",
    badgeClass: "bg-emerald-500/10 text-emerald-600 dark:text-emerald-400 border-emerald-500/20",
  },
  {
    value: "ADMIN_PPK",
    label: "Admin PPK (Realisasi Fisik Lapangan)",
    shortLabel: "Admin PPK",
    desc: "Input realisasi fisik (%) + upload foto/video bukti lapangan. Mengajukan ke MONEV untuk verifikasi.",
    badgeClass: "bg-purple-500/10 text-purple-600 dark:text-purple-400 border-purple-500/20",
  },
  {
    value: "BENDAHARA",
    label: "Bendahara (Realisasi Keuangan/SP2D)",
    shortLabel: "Bendahara",
    desc: "Input realisasi keuangan berbasis SP2D/Kas yang sudah benar-benar cair dari BPKAD.",
  ...
  },
  {
    ...
    desc: "Melihat & mempertanggungjawabkan seluruh realisasi pembangunan di OPD-nya. Tidak bisa input angka.",
  ...
  },
  {
    ...
    desc: "Executive view monitoring menyeluruh realisasi pembangunan daerah lintas seluruh OPD.",
    badgeClass: "bg-rose-500/10 text-rose-600 dark:text-rose-400 border-rose-500/20",
  },
  {
    value: "MONEV",
    label: "Tim MONEV (Verifikasi Lapangan)",
    shortLabel: "Tim MONEV",
    desc: "Tim Monitoring & Evaluasi Bagian Pembangunan Setda: turun lapangan, ACC atau TOLAK data PPK.",
